...
export const metadata: Metadata = {
  title: "Product — Tesseract AI",
  description:
    "Everything Tesseract AI ships: AI widget, flow builder, questions analytics, auto-surfaced insights, knowledge base, and MCP integrations.",
};
...
const features = [
  {
    ...
    body: "The Tesseract AI widget loads a stateful AI panel on the side of your users' screen. It knows what page they're on and what they've already told the agent — across page navigations, refreshes, and sessions.",
    bullets: [
...
<script src="https://cdn.usetesseract.ai/widget.js" async></script>`,
  ...
  },
  {
    ...
    body: "Design step-by-step flows from the Tesseract AI dashboard. Each flow defines what the AI should guide users through — set instructions, connect knowledge, and publish without a code deploy.",
    bullets: [
  ...
  },
  {
    ...
    body: "Tesseract AI analyses every message users send to your AI assistant and groups them by intent — how-to requests, blockers, navigation confusion, and recurring questions. You see the real language users use, not sanitised categories.",
    bullets: [
  ...
  },
  {
    ...
    body: "Tesseract AI continuously analyses your conversation data and surfaces actionable insight cards: where users are blocked, what knowledge is missing, which questions keep coming back. Each insight includes example quotes and a suggested action.",
    bullets: [
  ...
  },
  {
    ...
    body: "Upload your documentation, help center articles, or custom markdown to the Tesseract AI Knowledge Base. The AI agent retrieves the right content using hybrid BM25 + vector search with Reciprocal Rank Fusion — so it answers from your product knowledge, not hallucinated guesses.",
    bullets: [
  ...
  },
  {
    ...
    body: "Tesseract AI's MCP connector framework lets the AI call your own APIs mid-conversation — look up account data, check integration status, create resources. Built on the Model Context Protocol, it works with any REST endpoint.",
    bullets: [
      ...
      <section className="bg-[#0a0a0f] py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="https://app.usetesseract.ai/register"
