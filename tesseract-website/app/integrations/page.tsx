...
export const metadata: Metadata = {
  title: "Integrations — Tesseract AI",
  description: "Connect Tesseract AI to your existing stack. Native integrations with Slack, Segment, Intercom, HubSpot, webhooks, and more.",
};
...
const categories = [
  ...
  },
  {
    ...
    integrations: [
      {
        name: "Segment",
        desc: "Send Tesseract AI events (flow_started, step_completed, escalated) to your Segment workspace. All downstream tools get the data automatically.",
        status: "live",
        badge: "Popular",
      ...
      {
        name: "HubSpot",
        desc: "Update contact properties when users complete or fail onboarding. Trigger HubSpot workflows based on Tesseract AI events.",
        status: "live",
      ...
      {
        name: "Amplitude",
        desc: "Push Tesseract AI step events to Amplitude as user actions for correlation with downstream retention metrics.",
        status: "coming-soon",
        href: "#",
      },
    ],
  ...
  },
  {
    ...
    integrations: [
      {
        name: "Webhooks",
        desc: "Receive HTTP POST requests for any Tesseract AI event. Pipe data anywhere — your own database, custom dashboards, data warehouse.",
        status: "live",
        badge: "Recommended",
        href: "/docs/webhooks",
      },
      ...
      <div className="border-b border-slate-100 bg-[#fafbfc]">
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4">
            Tesseract AI works with your stack.
          </h1>
          <p className="text-xl text-slate-500 max-w-2xl mb-8 leading-relaxed">
            {liveCount} integrations live today. Connect Tesseract AI to your notification, analytics, support, and data tools — no custom engineering required.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-16">
        ...
        <div className="text-center bg-gradient-to-br from-brand/5 to-purple-50 border border-brand/15 rounded-3xl p-12">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="mailto:hello@usetesseract.ai?subject=Integration request"
