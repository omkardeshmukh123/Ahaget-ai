...
const frameworks = [
  ...
  { label: "Next.js", code: `// In app/layout.tsx:\nimport Script from 'next/script';\n// Inside <body>:\n<Script id="Tesseract AI-config">\n  {{\`window.TesseractConfig = { apiKey: "YOUR_KEY", userId: user.id };\`}}\n</Script>\n<Script src="https://cdn.usetesseract.ai/widget.js" async />` },
...
export default function QuickstartPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-8 py-12">
      ...
      <p className="text-xl text-slate-500 mb-12">Get Tesseract AI running in under 5 minutes.</p>
      ...
      <div className="space-y-10">
        <div>
          ...
          <p className="text-slate-600 mb-4">Sign up at <Link href="https://app.usetesseract.ai" className="text-brand hover:underline" target="_blank">app.usetesseract.ai</Link>. No credit card required.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-600 mb-4">Open your app in a browser. The Tesseract AI panel will appear on the right. Go to <strong>dashboard → Sessions</strong> to see the session appear in real time.</p>
