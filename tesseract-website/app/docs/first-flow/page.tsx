      ...
      <div className="space-y-14">
        ...
        <div>
          ...
          <p className="text-slate-600 mb-4">
            In your Tesseract AI dashboard, click <strong>Flows</strong> in the left sidebar, then <strong>+ New Flow</strong>. Give it a name like{" "}
          ...
          <div className="rounded-xl bg-[#0d1117] border border-white/5 p-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-slate-500 text-xs">Tesseract AI Dashboard — New Flow</span>
            </div>
        ...
        <div>
          ...
          <p className="text-slate-600 mb-4">
            Tell Tesseract AI when this step is done. This triggers moving to the next step automatically.
          </p>
          <div className="space-y-2">
        ...
        <div>
          ...
          <p className="text-slate-600 mb-4">
            Click <strong>Save &amp; Publish</strong>. Your flow is now live. Open your app in an incognito window — the Tesseract AI widget will start the flow automatically for new users.
          </p>
