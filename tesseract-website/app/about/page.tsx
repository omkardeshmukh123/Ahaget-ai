    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-bg-light border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="flex gap-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900">Tesseract AI Team</h3>
              ...
              <Link href="https://twitter.com/usetesseract" target="_blank" className="flex items-center gap-2 text-brand text-sm font-medium mt-4 hover:text-brand-dark transition-colors">
                <XIcon className="w-4 h-4" /> @usetesseract
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <Link href="mailto:hello@usetesseract.ai" className="inline-flex items-center gap-2 text-brand font-semibold hover:text-brand-dark transition-colors text-lg">
            <Mail className="w-5 h-5" /> hello@usetesseract.ai
          </Link>
        </div>
      </section>
    </div>
