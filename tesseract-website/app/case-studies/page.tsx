...
export const metadata: Metadata = {
  title: "Case Studies — Tesseract AI",
  description: "Real numbers from real teams using Tesseract AI onboarding.",
};
...
const caseStudies = [
  {
    ...
    industry: "B2B SaaS",
    plan: "Starter",
    quote: "We found the exact step where users were dropping off in the first 20 minutes. Tesseract AI paid for itself in the first week.",
    before: 23,
    after: 41,
    lift: 18,
  },
    ...
    <div className="pt-16">
      <section className="bg-bg-light py-16 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-xl text-slate-500">Real numbers from real teams using Tesseract.</p>
