...
export const metadata: Metadata = {
  title: "Security — Tesseract AI",
  description: "How Tesseract AI keeps your data and your users' data safe. SOC 2, encryption at rest and in transit, data residency, and more.",
};
...
const pillars = [
  ...
  },
  {
    ...
    desc: "Tesseract AI never uses your users' conversations or your product content to train AI models. Transcripts are yours — export or delete at any time. We process, we do not learn from.",
  ...
  },
  {
    ...
    desc: "Deployed on AWS us-east-1 and eu-west-1. Customer data is siloed by tenant. Tesseract AI employees cannot read your session transcripts without explicit support request and audit log.",
...
const practices = [
  ...
  "Vulnerability disclosure program — report to security@usetesseract.ai",
