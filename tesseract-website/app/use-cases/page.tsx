...
export const metadata: Metadata = {
  title: "Use Cases — Tesseract AI",
  description:
    "How SaaS teams use Tesseract AI for onboarding automation, support deflection, setup flows, and internal ops guidance.",
};
...
const useCases = [
  {
    ...
    desc: "Most SaaS users never complete onboarding. Not because your product is bad — because there's nobody to help them when they get confused at 11pm on a Tuesday. Tesseract AI runs the onboarding flow for you, 24/7.",
    howItWorks: [
      "User signs up and logs in for the first time",
      "Tesseract Agent appears, greets them, and starts the onboarding flow",
  ...
  },
  {
    ...
    howItWorks: [
      "User gets stuck and messages the Tesseract Agent",
  ...
  },
  {
    ...
    desc: "Some setups require your users to connect APIs, configure webhooks, or navigate admin panels they've never seen before. A Tesseract AI flow can walk them through it live, verify the connection worked, and catch failures before they give up.",
    howItWorks: [
      "User reaches the integration setup step in your product",
      "Tesseract Agent activates the setup flow automatically",
  ...
  },
  {
    ...
    desc: "Internal tools — CRMs, admin dashboards, ops platforms — get the worst onboarding. Tesseract AI can run in the same model for internal users as it does for customers. Guided flows for new hires, compliance workflows, and tool-specific procedures.",
    howItWorks: [
      "New employee logs into the internal tool for the first time",
      "Tesseract Agent starts the role-specific onboarding flow (scoped by user segment)",
      ...
      <section className="bg-[#0a0a0f] py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Tesseract AI runs wherever users need guidance — product onboarding, support deflection,
