  ...
  return (
    <footer className="bg-[#0e0e0e] w-full mt-0">
      <div className="flex flex-col md:flex-row justify-between items-start w-full px-12 py-20 max-w-7xl mx-auto gap-16">
        <div className="space-y-6 max-w-xs">
          <div className="flex items-center gap-3">
            <Image src="/tesseract-logo-space.jpg" alt="Tesseract AI" width={36} height={36} className="rounded-lg object-cover" />
            <span className="text-lg font-bold tracking-tight text-white">TESSERACT <span className="text-[#c1c1ff] font-light">AI</span></span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-12 pb-12 border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
        <span className="font-inter text-xs tracking-wide text-white/40">© 2025 Tesseract AI. All rights reserved.</span>
