    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#131313]/80 backdrop-blur-xl shadow-[0px_40px_80px_rgba(110,110,244,0.04)]' : 'bg-transparent'}`}>
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-[1440px] mx-auto">
        <Link href="/" className="flex items-center gap-3">
          <Image src="/tesseract-logo-space.jpg" alt="Tesseract AI" width={40} height={40} className="rounded-lg object-cover" />
          <span className="text-xl font-bold tracking-tight text-white">TESSERACT <span className="text-[#c1c1ff] font-light">AI</span></span>
        </Link>
