    ...
    <section ref={ref} className="section-stack section-pad-lg"
      ...
      <div className="container-sm" style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 12 }}>
          {[
            { q: "Tesseract AI cut our time-to-value from 14 days to 2. The agent handles questions we never even documented.", name: "Sarah Chen", role: "Head of Growth, TechFlow" },
