      ...
      <div className="space-y-4">
        <div className="glass rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-white text-sm font-semibold">Tesseract AI</span>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div>
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-8">
              Most &ldquo;AI onboarding&rdquo; is a chatbot that gives directions. Tesseract AI&apos;s agent scans your live DOM, finds the right element, and executes the action for the user — fill form, click button, highlight UI, navigate pages. The self-healing resolver finds it across 8 fallback strategies.
            </p>
            ...
            <div className="rounded-2xl overflow-hidden border border-white/8 shadow-glass bg-[#1a1a2e]">
              <div className="px-4 py-3 border-b border-white/5 flex items-center gap-3 bg-white/2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-brand-light text-[11px] font-medium">Tesseract AI</span>
                </div>
              </div>
