...
export const metadata: Metadata = {
  title: "How Ahaget Works — Docs",
  description: "Understand the core concepts behind Ahaget: agents, flows, steps, MTU, and the DOM action engine.",
};
...
const concepts = [
  {
    ...
    title: "The Agent",
    icon: "🤖",
    body: `The Ahaget Agent is an AI assistant embedded in your product via a lightweight JavaScript widget (~18kb gzipped). It appears as a panel on the side of the user's screen.
...
You define flows in the Ahaget dashboard using a no-code builder. Each flow has:
...
**Verification step** — the agent checks a condition before proceeding: URL match, element visible, API response, or user confirmation.`,
  },
  {
    ...
    icon: "📊",
    body: `MTU stands for Monthly Tracked User. One MTU = one unique user who interacts with a Ahaget-powered flow in a given calendar month.

A user counts as one MTU regardless of how many flows they complete or how many sessions they have that month.

Users are identified via the \`userId\` field in your AhagetConfig. If no userId is set, Ahaget uses a cookie-based anonymous ID (this still counts as an MTU).
...
1. data-Ahaget-id attribute (most reliable — add to elements you want targetable)
...
export default function ConceptsPage() {
  return (
    <div className="max-w-3xl mx-auto px-8 py-12">
      ...
      <h1 className="text-4xl font-black text-slate-900 mb-4">How Ahaget works</h1>
