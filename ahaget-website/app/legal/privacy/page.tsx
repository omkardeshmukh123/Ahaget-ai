...
export const metadata: Metadata = {
  title: "Privacy Policy — Ahaget",
  description: "How Ahaget collects, uses, and protects your data and your users' data.",
};
...
const sections = [
  {
    id: "overview",
    title: "1. Overview",
    content: `Ahaget Inc. ("Ahaget", "we", "us", "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard information in connection with the Ahaget platform ("Service").

This policy applies to:
- Customers (companies that use Ahaget to build onboarding flows)
- End Users (end users of Customer applications who interact with Ahaget-powered experiences)
- Website visitors (people who visit useahaget.ai)`,
  },
  {
    id: "what-we-collect",
...
Usage data: How you interact with the Ahaget dashboard — pages visited, features used, configuration changes made.

Billing data: Payment method details are collected and processed by Stripe. We do not store raw card numbers.

Session transcript data: The AI conversations your end users have with Ahaget-powered agents, including messages exchanged, actions executed, and steps completed or failed. This data is stored encrypted and accessible only to your account.

Metadata you configure: Any additional context you pass via the AhagetConfig object (e.g., userId, planName) — you control what is sent.`,
  },
  {
    id: "how-we-use",
...
You may request deletion of all Customer Data at any time from Settings → Data, or by emailing privacy@useahaget.ai.`,
  },
  {
    id: "security",
    title: "6. Security",
...
- Understand how visitors use useahaget.ai (analytics)
...
To exercise these rights, contact privacy@useahaget.ai. We will respond within 30 days.
...
To exercise these rights, contact privacy@useahaget.ai or use the data deletion option in your account settings.`,
  },
  {
    id: "children",
    title: "10. Children's Privacy",
    content: `The Service is not directed to individuals under the age of 16. We do not knowingly collect personal information from children under 16. If you believe we have collected data from a child under 16, please contact us immediately at privacy@useahaget.ai.`,
  },
  {
    id: "changes",
...
Email: privacy@useahaget.ai
Response time: Within 30 days for formal GDPR/CCPA requests, within 5 business days for general inquiries.

For security disclosures: security@useahaget.ai
For general questions: hello@useahaget.ai`,
  },
];
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 space-y-2">
                ...
                <a href="mailto:privacy@useahaget.ai" className="block text-sm text-slate-500 hover:text-slate-900 transition-colors">
                  privacy@useahaget.ai
                </a>
              </div>
            </div>
          </aside>
