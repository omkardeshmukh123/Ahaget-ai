...
export const metadata: Metadata = {
  title: "System Status — Ahaget",
  description: "Live status and uptime for all Ahaget systems — widget delivery, dashboard, API, and AI processing.",
};
    ...
    <div className="pt-16 bg-[#fafbfc] min-h-screen">
      ...
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-3">Ahaget System Status</h1>
          <p className="text-slate-500 text-lg">Real-time status for all Ahaget services.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-14 space-y-10">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a
              href="mailto:status@useahaget.ai?subject=Subscribe to status updates"
