...
<p className="font-body text-xl md:text-2xl text-on-surface-variant leading-relaxed max-w-xl">
                    Whether you're Evaluating Ahaget, need help, or just want to say hi — we respond within a few hours.
                </p>
</div>
...
<button className="px-5 py-2 rounded-full border border-outline-variant/20 hover:border-primary/50 text-sm font-medium transition-all text-on-surface-variant" type="button">Evaluating Ahaget</button>
...
<p className="text-2xl font-headline font-semibold">hello@useahaget.ai</p>
</div>
...
<div className="group py-6 border-b border-outline-variant/10 cursor-pointer">
<div className="flex justify-between items-center mb-2">
<h3 className="text-xl font-headline font-medium group-hover:text-primary transition-colors">Can I use Ahaget for free?</h3>
<span className="material-symbols-outlined text-primary group-hover:rotate-45 transition-transform">add</span>
</div>
<p className="text-on-surface-variant/80 hidden group-hover:block transition-all">Absolutely. Our free tier allows you to test Ahaget on up to 100 monthly active users.</p>
</div>
</div>
</section>
