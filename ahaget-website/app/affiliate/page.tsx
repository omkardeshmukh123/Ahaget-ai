...
export const metadata: Metadata = {
  title: "Affiliate Program — Ahaget",
  description: "Earn 30% recurring commission for every customer you refer to Ahaget. Join founders, agencies, and growth consultants who earn with Ahaget.",
};
...
const tiers = [
  {
    ...
    payout: "Monthly",
    perks: ["Affiliate dashboard", "Custom link", "Ahaget swag kit"],
  },
  {
    name: "Partner",
    commission: "30%",
      ...
      <div className="relative bg-gradient-to-br from-[#06060f] via-[#0f0f2a] to-[#1a1040] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-10">
            Refer SaaS founders, product teams, or growth leads to Ahaget — and earn a percentage of their subscription every single month, for as long as they stay.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="mailto:partners@useahaget.ai?subject=Affiliate application"
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { n: "01", title: "Apply", desc: "Email partners@useahaget.ai with your name, audience, and how you plan to promote Ahaget." },
              { n: "02", title: "Get approved", desc: "We review applications within 2 business days and issue your unique referral link." },
              { n: "03", title: "Share", desc: "Promote Ahaget via blog, newsletter, social, or directly to your clients and network." },
        ...
        <div className="text-center bg-gradient-to-br from-brand/5 to-purple-50 border border-brand/15 rounded-3xl p-12">
          ...
          >
            Apply now — partners@useahaget.ai
          </a>
        </div>
      </div>
    </div>
