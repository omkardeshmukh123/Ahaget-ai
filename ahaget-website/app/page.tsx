...
<p className="text-xl text-on-surface-variant max-w-xl mb-12 font-light leading-relaxed">
                        Ahaget is the invisible guide that walks users through your product in real-time. Stop guessing where they get stuck.
                    </p>
...
<span className="text-xs uppercase tracking-widest font-bold text-primary">Ahaget Agent Active</span>
</div>
...
<div className="text-on-surface-variant text-sm uppercase tracking-widest font-semibold">Total time to install Ahaget</div>
</div>
</div>
</section>
...
<p className="text-on-surface-variant text-lg">Traditional onboarding is linear. Real usage is chaotic. Ahaget fills the gap with intelligence.</p>
</div>
...
<p className="text-on-surface-variant text-lg mb-8">Deploy Ahaget as easily as a tracking pixel. It instantly maps your UI without manual tagging or complex selectors.</p>
</div>
<div className="w-full lg:w-1/2">
...
<div className="pl-4">
<span className="text-primary">window</span>.<span className="text-tertiary">ahagetSettings</span> = {"{"} <span className="text-on-surface-variant">app_id</span>: <span className="text-secondary">"px_8921"</span> {"}"};
                            </div>
<div className="pl-4">
<span className="text-primary">import</span> Ahaget <span className="text-primary">from</span> <span className="text-secondary">'@ahaget/agent'</span>;
                            </div>
<div className="pl-4">
                                Ahaget.<span className="text-tertiary">init</span>();
                            </div>
...
<h3 className="text-4xl font-bold mb-6 font-display">Ahaget watches your users.</h3>
...
<p className="text-on-surface-variant text-lg mb-8">Ahaget doesn't just watch. It steps in with context-aware chat, UI highlights, and proactive suggestions to get users to "Aha!" moments.</p>
</div>
<div className="w-full lg:w-1/2">
...
<div className="font-bold">Ahaget Assistant</div>
</div>
<div className="space-y-4">
...
<p className="text-on-surface-variant max-w-sm">Ahaget can click buttons, fill forms, and navigate workflows on behalf of the user to demonstrate value.</p>
</div>
