...
<div className="text-2xl font-black tracking-tighter text-white">AHAGET AI</div>
...
<p className="text-sm text-on-surface-variant/80">Ideal for exploring the Ahaget ecosystem without risk.</p>
</div>
...
<div className="text-xl font-bold text-white mb-4">AHAGET AI</div>
<p className="text-white/40 text-xs tracking-widest uppercase font-['Inter']">© 2025 Ahaget. All rights reserved.</p>
</div>
