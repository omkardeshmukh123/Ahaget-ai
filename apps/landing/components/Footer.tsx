        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-10">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed">
              The AI employee for SaaS. Activate users, drive adoption, prevent churn, close upsells.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-500">
                <li><a href="mailto:hello@ahaget.ai" className="hover:text-white transition-colors">Contact</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-500">
                ...
                <li><a href="mailto:security@ahaget.ai" className="hover:text-white transition-colors">Security</a></li>
              </ul>
            </div>
          </div>
        </div>
