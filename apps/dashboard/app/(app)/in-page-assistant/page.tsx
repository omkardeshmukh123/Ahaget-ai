  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center">
        ...
        <h2 className="text-lg font-semibold text-slate-900 mb-2">Open the Tesseract Editor in your app</h2>
        <p className="text-slate-500 text-sm leading-relaxed mb-7 max-w-sm mx-auto">
          To create your first AI agent, open your app with the Tesseract widget installed and click the Tesseract badge to launch the editor.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            id="btn-open-tesseract-editor"
        ...
        <div className="mt-10 pt-8 border-t border-slate-100 text-left space-y-3">
          ...
          {[
            ...
            { done: false, label: 'Install the Tesseract snippet on your site' },
            { done: false, label: 'Open your app and launch the Tesseract editor' },
